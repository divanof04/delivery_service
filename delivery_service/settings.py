...
if 'test' in os.sys.argv:
    ...
    DATABASES['default']['PASSWORD'] = os.getenv('MYSQL_ROOT_PASSWORD', 'root_pass')
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs', 'delivery_service.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API для службы доставки',
    'VERSION': '1.0.0',
